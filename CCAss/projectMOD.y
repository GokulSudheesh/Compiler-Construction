...
%token HEADER MAIN LB RB LCB RCB TAB SC COLON QMARK COMA IF ELSE FOR DO WHILE VAR NUMBER ET EQ GT LT GTE LTE NE AND OR NOT PLUS MINUS MUL DIV MOD EXP UPLUS UMINUS
...
DECLARATION_STATEMENT: VAR_LIST COLON COLON DATA_TYPE{}
