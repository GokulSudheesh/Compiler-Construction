...
{
       0,   137,   137,   139,   143,   146,   151,   158,   159,   162,
     166,   172,   175,   180,   181,   183,   184,   186,   187,   188,
     195,   201,   208,   213,   214,   216,   217,   220,   222,   242,
     278,   290,   296,   308,   321,   327,   342,   363
};
#endif
...
static const char *const yytname[] =
{
  ...
  "RCB", "SC", "COMA", "EQ", "PLUS", "STAR", "LSB", "RSB", "UPLUS",
  "VAR_LABEL", "INT", "CHAR", "UNSIGNED", "SHORT", "LONG", "AMB", "NUM",
  "$accept", "prm", "HEAD", "PROC", "MAIN_TYPE", "BODY", "STATEMENTS",
  "STATEMENT", "DECLARATION_STATEMENT", "EXT_DATA_TYPE", "TYPE",
  "TYPE_SIGN", "TYPE_EXTN", "VAR_LIST", "EXT_VAR", "DIM_SEQ", "STAR_SEQ",
  "DIM", "PROGRAM_STATEMENT", "A_EXPN", YY_NULLPTR
};
#endif
...
{
       0,   -13,    23,     1,   -13,   -13,   -13,    21,    26,    27,
      28,    17,    19,    19,   -13,   -13,    19,   -13,    31,   -13,
      -3,   -13,    34,    39,   -13,    38,    32,    50,    50,   -13,
     -13,    34,    56,    57,    36,   -13,   -13,    44,    19,    19,
      19,    19,   -13,   -13,   -13,   -13,    34,    52,   -13,   -13,
     -13,    -1,    -7,     2,    43,   -13,    45,   -13,    52,   -13,
     -13,    53,   -13,   -13
};
...
{
       0,     3,     0,     0,     1,     5,     2,     0,     0,     0,
       0,    16,     0,     0,    33,    15,     0,    34,     0,     6,
      16,     9,    26,    19,    10,     0,     0,    35,    37,     4,
       7,    26,     0,    21,     0,    17,    18,     0,     0,     0,
       0,     0,    32,    31,    25,    11,    26,    24,    13,    14,
      12,     0,    29,    30,     0,    20,     0,    22,    24,    28,
      36,     0,    23,    27
};
...
static const yytype_int8 yypgoto[] =
{
     ...
     -13,   -13,   -13,    24,   -13,    14,    42,   -13,   -13,   -12
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     3,     6,     7,    18,    19,    20,    21,    22,
      50,    23,    37,    32,    33,    57,    34,    58,    24,    25
};
...
{
      26,    27,    12,     1,    28,    -8,    40,    41,    59,    42,
      13,    39,    40,    41,    14,    42,    41,    15,    42,     5,
      16,    17,    12,     4,    12,     8,    51,    52,    53,    54,
      13,     9,    13,    10,    14,    11,    14,    15,    43,    29,
      16,    17,    16,    17,    39,    40,    41,    31,    42,    38,
      39,    40,    41,    47,    42,    39,    40,    41,    60,    42,
      35,    36,    48,    49,    41,    45,    56,    46,    63,    61,
      55,    30,    62,    44
};

static const yytype_int8 yycheck[] =
{
      12,    13,     5,     3,    16,     8,    13,    14,     9,    16,
      13,    12,    13,    14,    17,    16,    14,    20,    16,    18,
      23,    24,     5,     0,     5,     4,    38,    39,    40,    41,
      13,     5,    13,     6,    17,     7,    17,    20,     6,     8,
      23,    24,    23,    24,    12,    13,    14,    13,    16,    11,
      12,    13,    14,    17,    16,    12,    13,    14,    15,    16,
      21,    22,    18,    19,    14,     9,    14,    10,    15,    24,
      46,    20,    58,    31
};
...
{
       0,     3,    26,    27,     0,    18,    28,    29,     4,     5,
       6,     7,     5,    13,    17,    20,    23,    24,    30,    31,
      32,    33,    34,    36,    43,    44,    44,    44,    44,     8,
      31,    13,    38,    39,    41,    21,    22,    37,    11,    12,
      13,    14,    16,     6,    41,     9,    10,    17,    18,    19,
      35,    44,    44,    44,    44,    38,    14,    40,    42,     9,
      15,    24,    40,    15
};
...
#line 175 "project.y"
                                         {
			(yyval.ext_type).is_unsigned=temp_type_obj.is_unsigned=(yyvsp[-2].type_info);
			(yyval.ext_type).length_spec=temp_type_obj.length_spec=(yyvsp[-1].type_info);
			(yyval.ext_type).name=temp_type_obj.name=(yyvsp[0].type_info);
			}
#line 1547 "y.tab.c"
    break;
...
#line 195 "project.y"
                                {
						temp_var.pointer_depth=(yyvsp[-2].ext_var).pointer_depth;;
						strcpy(temp_var.name,(yyvsp[-2].ext_var).name);
...
#line 201 "project.y"
                                {
						temp_var.pointer_depth=(yyvsp[0].ext_var).pointer_depth;;
						strcpy(temp_var.name,(yyvsp[0].ext_var).name);
						insert_to_table(temp_var,temp_type_obj);
				}
#line 1609 "y.tab.c"
    break;
...
#line 208 "project.y"
                                    {        
			        strcpy((yyval.ext_var).name,(yyvsp[-1].test_name));
				(yyval.ext_var).pointer_depth=(yyvsp[-2].type_info)+(yyvsp[0].type_info);
...
#line 1619 "y.tab.c"
  ...
  case 23:
#line 213 "project.y"
                   {(yyval.type_info)=(yyvsp[0].type_info)+1;printf("\n [] depth=%d",(yyval.type_info));}
#line 1625 "y.tab.c"
    break;

  case 24:
#line 214 "project.y"
           {(yyval.type_info)=0;printf("\n [] depth=%d",(yyval.type_info));}
#line 1631 "y.tab.c"
    break;

  case 25:
#line 216 "project.y"
                        {(yyval.type_info)=(yyvsp[0].type_info)+1;printf("\n pointer depth=%d",(yyval.type_info));}
#line 1637 "y.tab.c"
    break;
...
#line 223 "project.y"
                                {
					if((yyvsp[-3].expn_type).type!=(yyvsp[-1].expn_type).type)
					{
						printf("\n Incompatible type in assignment");
						exit(0);
					}else if((yyvsp[-3].expn_type).data_depth!=(yyvsp[-1].expn_type).data_depth)
					{
						printf("\n Incompatible pointer type in assignment");
						exit(0);
					}
					else if((yyvsp[-3].expn_type).isValue==1)
					{
...
#line 308 "project.y"
                                {		
					exprn_type t;
					lookup_in_table((yyvsp[0].test_name),&t);
					if(t.type==-1)
					{
						printf("\n variabla %s undeclared",(yyvsp[0].test_name));
						exit(0);
					}
					(yyval.expn_type).type=t.type;
					(yyval.expn_type).data_depth=t.data_depth;	
