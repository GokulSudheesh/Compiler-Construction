...
{
       0,   114,   114,   116,   120,   123,   128,   135,   136,   139,
     143,   149,   152,   157,   158,   160,   161,   163,   164,   165,
     172,   178,   184,   192,   198,   199,   200,   201
};
#endif
...
static const char *const yytname[] =
{
  ...
  "RCB", "SC", "COMA", "EQ", "PLUS", "STAR", "VAR_LABEL", "INT", "CHAR",
  "UNSIGNED", "SHORT", "LONG", "$accept", "prm", "HEAD", "PROC",
  "MAIN_TYPE", "BODY", "STATEMENTS", "STATEMENT", "DECLARATION_STATEMENT",
  "EXT_DATA_TYPE", "TYPE", "TYPE_SIGN", "TYPE_EXTN", "VAR_LIST", "EXT_VAR",
  "PROGRAM_STATEMENT", "A_EXPN", YY_NULLPTR
};
#endif
...
{
      -2,   -31,     7,     1,   -31,   -31,   -31,    21,    22,    20,
      23,     3,    17,   -31,    24,   -31,    -5,   -31,    15,     0,
     -31,    -1,   -31,   -31,   -31,    25,    26,   -31,   -31,     6,
      -1,   -31,    -7,   -31,    15,   -31,   -31,   -31,     2,   -31,
      -1,    -1,   -31,   -31,    11,    11
};
...
{
       0,     3,     0,     0,     1,     5,     2,     0,     0,     0,
       0,    16,     0,    15,     0,     6,    16,     9,     0,    19,
      10,     0,     4,     7,    22,     0,    21,    17,    18,     0,
       0,    27,     0,    11,     0,    13,    14,    12,     0,    23,
       0,     0,    20,    26,    24,    25
};
...
{
      38,     1,    39,    -8,    30,    40,    41,     4,    43,    12,
      44,    45,    13,    31,    40,    41,     5,    12,    27,    28,
      13,    35,    36,    40,    41,     8,    10,     9,    21,    24,
      11,    42,    22,     0,    33,    23,    34
};

static const yytype_int8 yycheck[] =
{
      30,     3,     9,     8,     5,    12,    13,     0,     6,    14,
      40,    41,    17,    14,    12,    13,    15,    14,    18,    19,
      17,    15,    16,    12,    13,     4,     6,     5,    11,    14,
       7,    34,     8,    -1,     9,    16,    10
};
...
{
       0,     3,    21,    22,     0,    15,    23,    24,     4,     5,
       6,     7,    14,    17,    25,    26,    27,    28,    29,    31,
      35,    11,     8,    26,    14,    33,    34,    18,    19,    32,
       5,    14,    36,     9,    10,    15,    16,    30,    36,     9,
      12,    13,    33,     6,    36,    36
};
...
#line 184 "project.y"
                    {        
			        strcpy((yyval.ext_var).name,(yyvsp[0].test_name));
				(yyval.ext_var).pointer_depth=0;
		      }
#line 1574 "y.tab.c"
    break;
