...
HEADERS : HEADER HEADERS {printf("<HEADER HEADERS>");}| HEADER {printf("<HEADER>");}
HEADER	: HASH INCLUDE LT HEADER_FILE GT {printf("<HASH INCLUDE LT HEADER_FILE GT>");}| HASH {printf("ily");} INCLUDE {printf("ily");}DQUOTE HEADER2 HEADER_FILE DQUOTE {printf("<HASH INCLUDE DQUOTE HEADER2 HEADER_FILE DQUOTE>");}
