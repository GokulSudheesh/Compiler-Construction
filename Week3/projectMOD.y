...
%token HEADER MAIN LB RB LCB RCB SC COMA NULL_TOK IF ELSE VAR ET EQ GT LT GTE LTE NE AND OR NOT PLUS MINUS MUL DIV MOD EXP UPLUS UMINUS
...
PROGRAM_STATEMENTS : PROGRAM_STATEMENT PROGRAM_STATEMENTS 
			...
			| IF LOGICAL_EXPN LCB BODY2 RCB
			| IF LOGICAL_EXPN LCB BODY2 RCB ELSE LCB BODY2 RCB
			| PROGRAM_STATEMENT
